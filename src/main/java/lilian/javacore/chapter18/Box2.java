...
//  В этой версии класа Box  один объект допускается
//  инициализировать другим объектом
public class Box2 {
    double width, height, depth;

    //  Обратите внимение на этот конструктор.
    //  В качестве параметра в нем используется в объект типа Box
    ...
    //  конструктор, использоваемый при указании всех размеров
    ...
    //  конструктор, использоваемый, если ни один из размеров не указан
    Box2() {
